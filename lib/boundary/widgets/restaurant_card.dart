...
import 'package:foodapp/boundary/widgets/restaurant_favorite_button.dart';
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => RestaurantReviewsPage(restaurant: restaurant),
          ),
        );
      },
      child: Container(
